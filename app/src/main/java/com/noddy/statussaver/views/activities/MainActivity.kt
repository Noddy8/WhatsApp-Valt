...
import com.noddy.statussaver.views.fragments.FragmentMore
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            // Set click listeners for the app bar icons
            directMessageBtn.setOnClickListener {
                startActivity(Intent(activity, DirectMessageActivity::class.java))
            }
